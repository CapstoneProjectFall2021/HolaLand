...
public interface IRepositoryQuery {
    ...
    String WORK_REQUEST_JOBS_SAVE_GET_ALL = "SELECT * FROM work_request_jobs_save WHERE work_request_jobs_save_deleted = 0";
    String WORK_REQUEST_JOBS_SAVE_GET_ONE = "SELECT * FROM work_request_jobs_save WHERE work_request_jobs_save_id = ? AND work_request_jobs_save_deleted = 0";
