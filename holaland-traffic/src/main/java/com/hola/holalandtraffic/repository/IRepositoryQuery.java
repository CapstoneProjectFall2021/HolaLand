...
public interface IRepositoryQuery {
    ...
    String MOTORBIKE_TAXI_DRIVERS_GET_ALL = "SELECT * FROM tf_motorbike_taxi_drivers";
    String MOTORBIKE_TAXI_DRIVERS_GET_ONE = "SELECT * FROM tf_motorbike_taxi_drivers WHERE tf_motorbike_taxi_drivers_id = ?";
