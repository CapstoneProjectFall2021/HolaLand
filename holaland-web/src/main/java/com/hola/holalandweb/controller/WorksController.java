...
public class WorksController {
    ...
    @GetMapping("works/list-applied/users-applied")
    public String getListUserApplied(
            @RequestParam("requestId") Integer requestId,
            Model model) {
        List<UserDetail> listUserApplied = workRequestApplyService.getAllUserApplied(requestId, Constants.STT_WORK_CODE_WAITING_REPOSITORY);
        ...
        model.addAttribute("listUserApplied", listUserApplied);
        model.addAttribute("listApplied", listApplied);
        model.addAttribute("page", 8);
        return "module-works";
    }
